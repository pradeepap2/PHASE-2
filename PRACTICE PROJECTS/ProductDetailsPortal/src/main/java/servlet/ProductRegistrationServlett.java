...
/**
 * Servlet implementation class ProductRegistrationServlett
 */
@WebServlet("/ProductRegistrationServlett")
public class ProductRegistrationServlett extends HttpServlet {
